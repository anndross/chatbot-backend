...
export const addProductController = async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
    const { product, storeName, platformName, orderFormId } = req.body;
